...
CustomKeywords.'reusablefunctions.reusablefunctions.Login'(GlobalVariable.PenyemakPTJ, findTestData('ispekstestdata').getValue( 2, 5))
...
WebUI.waitForElementClickable(findTestObject('Perolehan/006 Arahan Bayaran/004 Penyemak/button_OK_berjaya_disemak'), 300)

'declare object to find as an element'
WebElement element = WebUiCommonHelper.findWebElement(findTestObject('Perolehan/006 Arahan Bayaran/004 Penyemak/button_OK_berjaya_disemak'), 300)
