...
WebUI.click(findTestObject('Perolehan/006 Arahan Bayaran/001 Inden Kerja - EFT/Date_Picker_tarikh_Invois'), FailureHandling.STOP_ON_FAILURE)

'Delay'
WebUI.delay(2)

'Click Today'
WebUI.click(findTestObject('Perolehan/006 Arahan Bayaran/001 Inden Kerja - EFT/Date_picker_TI_Today'), FailureHandling.STOP_ON_FAILURE)
