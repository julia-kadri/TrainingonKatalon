...
WebUI.click(findTestObject('Perolehan/006 Arahan Bayaran/Select_Nama_Pembekal'))
...
'Input Perihal'
WebUI.setText(findTestObject('Perolehan/006 Arahan Bayaran/input_Perihal'), 'This is a test for Arahan Bayaran Julia ' + 
    mydate)
...
'Input Amaun'
WebUI.setText(findTestObject('Perolehan/006 Arahan Bayaran/input_Amaun_Invois_RM'), '6.25')
...
WebUI.click(findTestObject('Perolehan/006 Arahan Bayaran/button_Simpan'))
