...
WebUI.setText(findTestObject('Perolehan/002 Penyedia_RekodBaru/007 Rekod Baru Pesanan Tempatan/input_kod_pembekal'), GlobalVariable.kod_pembekal_cek)
...
WebUI.setText(findTestObject('Perolehan/002 Penyedia_RekodBaru/007 Rekod Baru Pesanan Tempatan/input_kod_Akaun'), GlobalVariable.kod_akaun_cek)
...
WebUI.setText(findTestObject('Perolehan/002 Penyedia_RekodBaru/007 Rekod Baru Pesanan Tempatan/input_kod_barang'), GlobalVariable.kod_barang_cek)
