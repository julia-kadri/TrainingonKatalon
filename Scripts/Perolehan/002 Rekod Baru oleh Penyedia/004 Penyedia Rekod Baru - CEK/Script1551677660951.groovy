...
WebUI.click(findTestObject('Perolehan/002 Penyedia_RekodBaru/Select_Kategori_Pesanan_PERKHIDMATAN'))

'Input Kuantiti as 3'
WebUI.setText(findTestObject('Perolehan/002 Penyedia_RekodBaru/input_kuantiti'), '3')
...
'Input kuantiti as 3'
WebUI.setText(findTestObject('Perolehan/002 Penyedia_RekodBaru/input_Kuantiti_senarai_barang'), '3')
