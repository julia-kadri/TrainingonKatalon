...
WebUI.doubleClick(findTestObject('Perolehan/005 Kemasukan Terimaan/Perihal_Barang'))

'Input value for Dihantar using spinner - click until 5 times'
for (def index : (1..5)) {
    WebUI.click(findTestObject('Perolehan/005 Kemasukan Terimaan/Spinner_up_Dihantar'))
}

'Input value for Diterima using spinner - click until 5 times'
for (def index : (1..5)) {
